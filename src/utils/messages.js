...
export const ERROR_MESSAGES = {
    ...
    NO_FILE_UPLOADED: "No file is uploaded!",
    INVALID_CREDENTIALS: "Invalid credentials",
    S3_UPLOAD_FAILED: "Failed to upload image to S3",
    S3_DELETE_FAILED: "Failed to delete image from S3",
    PRODUCT_NAME_DUBLICATE: "The product name already exists. Choose another name.",
    ...
    EMAIL_REQUIRED: "Email is required!",
    CART_NOT_FOUND_USER: 'Cart not found for this user.',
    CART_NOT_FOUND_USER: "Cart not found for the user.",
    CART_EMPTY: "Your cart is empty. Please add items to your cart before placing an order.",
    USER_NOT_FOUND: "User not found.",
    ORDER_SAVE_ERROR: "Error occurred while placing the order.",
    NO_ORDERS_FOUND: "No orders found for this user",
    ORDER_NOT_FOUND: "Order not found",
    INVALID_PRODUCT_ID: "Invalid product ID",
    LOW_STOCK: "No low stock products found"
};
